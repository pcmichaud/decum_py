...
if __name__ == '__main__':
        ...
        print('theta = ',theta)
        print('dx = ',dx)
        partial_distance = partial(concentrated_distance_within,data=data,isfree=isfree,ipars=pars,npartitions=256, iwithin = True,  iann = False, irmr= True, iltc = False, scn_name='ez_rmr')
        ...
        np.save('output/estimates_ez_rmr',opt_pars)
