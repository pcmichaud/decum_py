...
if __name__ == '__main__':
        ...
        print('theta = ',theta)
        print('dx = ',dx)
        partial_distance = partial(concentrated_distance_within,data=data,isfree=isfree,ipars=pars,npartitions=256, iwithin = True,  iann = True, irmr= False, iltc = False, scn_name='ez_ann')
        ...
        np.save('output/estimates_ez_ann',opt_pars)
