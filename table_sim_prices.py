...
df_p.to_stata('output/sim_annuities.dta')
...
df_p.to_stata('output/sim_ltci.dta')
...
df_p.to_stata('output/sim_rmr.dta')
...
table = table.round(3)
print(table)
table.to_latex('output/table_simulated_elasticities_ez.tex')
