...
if __name__ == '__main__':
        ...
        dx[5] = 1.0
        dx[6] = 1.0
        partial_distance = partial(concentrated_distance_within,data=data,isfree=isfree,ipars=pars,npartitions=256, iwithin = True,  scn_name='bo')
        ...
        np.save('output/estimates_bo',opt_pars)
