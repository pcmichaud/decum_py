...
if __name__ == '__main__':
	...
	partial_distance = partial(concentrated_distance_within,data=data,isfree=isfree,ipars=pars,npartitions=250, scn_name='nokappa')
	...
	np.save('output/estimates_nokappa',opt_pars)
