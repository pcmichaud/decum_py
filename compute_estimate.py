...
if __name__ == '__main__':
        ...
        data = init_data()
        #data = data.sample(n=350, random_state = 1234)
        maxeval=10000
        pars = np.array([0.459,
                        0.018,
                        0.812,
        ...
        partial_distance = partial(concentrated_distance_within,data=data,isfree=isfree,ipars=pars,npartitions=256, iwithin = True,  scn_name='precise')
        ...
        np.save('output/estimates_precise',opt_pars)
